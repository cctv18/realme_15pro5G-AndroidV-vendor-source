...
static atomic_t level_protect_enable = ATOMIC_INIT(1);
...
static void page_should_be_protect(void *data, struct folio *folio, unsigned long nr_scanned, s8 priority,
